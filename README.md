...
- ✅ **WiFi 调优** — 2.4G/5G hostapd 配置对齐，防设备重连导致全屋断联
...
| 2026-06-12 | Phase 12：修复启动后认证循环失败（v2.0 守护进程 + v3.0 认证脚本） |
| 2026-06-18 | Phase 13：设备重连断联修复 v3 — DHCP 168h + hostapd 配置对齐 + UAPSD/PMKSA |
